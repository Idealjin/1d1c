...
model_name = 'datas/opencv/res10_300x300_ssd_iter_140000.caffemodel'
prototxt_name = 'datas/opencv/deploy.prototxt.txt'
min_confidence = 0.3
file_name = "datas/opencv/image/marathon_01.jpg"
title_name = 'dnn Deep Learnig object detection'
frame_width = 300
frame_height = 300

def selectFile():
    file_name =  filedialog.askopenfilename(initialdir = "datas/opencv/image",title = "Select file",filetypes = (("jpeg files","*.jpg"),("all files","*.*")))
